                ...
                <div key={name} className="flex items-center">
                  ...
                  {ability.description && (
                    <button
                      ...
                      className="bg-gray-200 dark:bg-gray-600 text-slate-700 dark:text-slate-300/90 rounded-full cursor-pointer w-5 h-5 flex items-center justify-center text-base ml-1.5 focus"
                    >
                      ?
                    </button>
                  )}
