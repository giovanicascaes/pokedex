        ...
        >
          {transition(
            (styles, visible) =>
              visible && (
                <animated.div
                  className="absolute z-10 -top-full min-w-max max-w-[300px] left-1/2 px-2 py-1 text-sm normal-case font-normal rounded-md border shadow-md bg-slate-600 border-slate-700/70 text-slate-100 dark:bg-slate-700 dark:border-slate-500/40 dark:text-slate-200 dark:shadow-black/20"
                  style={{ ...styles }}
                >
