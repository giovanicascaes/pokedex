...
export default function Button({
  ...
  return (
    <button
      ...
      className={twMerge(
        variant !== "unstyled" && [
          "w-full pl-3 pr-2 py-2 shadow-md rounded-lg text-start text-sm bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:text-black dark:hover:text-white hover:bg-slate-100/50 dark:hover:bg-white/[0.16] active:bg-slate-100 dark:active:bg-white/[0.21] flex items-center focus-default group",
          disabled &&
